...
class SwiperUserCard extends StatefulWidget {
  final ChatUser user;

  const SwiperUserCard({super.key, required this.user});

  @override
  State<SwiperUserCard> createState() => _SwiperUserCardState();
}

class _SwiperUserCardState extends State<SwiperUserCard> {
