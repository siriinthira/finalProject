...
class APIs {
  ...
  static ChatUser me = ChatUser(
      ...
      schools: [], 
      hobbies: [], 
      location: '', starRatings: 0, featureVector: {}, sumRatings: 0, avgRatings: 0, resourcelinks: []);
  ...
  static Future<void> createUser() async {
    ...
    final chatUser = ChatUser(
        ...
        schools: [], 
        hobbies: [], 
        location: '', starRatings: 0, sumRatings: 0, avgRatings: 0, resourcelinks: [], featureVector: {});
